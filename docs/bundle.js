...
var NavItem = (_temp2 = _class = function (_PureComponent) {
    ...
    function NavItem() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = NavItem.__proto__ || Object.getPrototypeOf(NavItem)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (event) {
            var _this$props = _this.props,
                href = _this$props.href,
                disabled = _this$props.disabled,
...
/******/ });
//# sourceMappingURL=bundle.js.map?ab0788ba17d175e94728